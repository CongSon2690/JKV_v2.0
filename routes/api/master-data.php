...
use App\Http\Controllers\Api\MasterData\MasterErrorController;
...
Route::prefix('settings')->group(function () {
    ...
    Route::prefix('error')->group(function () {
        Route::get('/', [MasterErrorController::class, 'index']);
        Route::get('/history', [MasterErrorController::class, 'history']);
    });
