...
"use strict";
/*!*************************************************!*\
  !*** ./resources/js/production-plan/command.js ***!
  \*************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lang__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../lang */ "./resources/js/lang/index.js");
$('.select2').select2();

var route = "".concat(window.location.origin, "/api/productionplan/command");
var route_show = "".concat(window.location.origin, "/production-plan/detail");
console.log(route);
var table = $('table').DataTable({
  ...
  columns: [{
    ...
    data: 'Month',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])('Month')
  }, {
    data: 'Year',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])('Year')
  }, {
    data: 'Note',
    defaultContent: '',
