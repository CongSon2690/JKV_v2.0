...
"use strict";
/*!**************************************************!*\
  !*** ./resources/js/control_agv/list_command.js ***!
  \**************************************************/
__webpack_require__.r(__webpack_exports__);
...
var route = "".concat(window.location.origin, "/api/control-agv/trans/list-command-api"); // console.log(route);
...
var table = $('table').DataTable({
  ...
  aaSorting: [],
  language: {
    lengthMenu: (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('Number of records _MENU_'),
    info: (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('Showing _START_ to _END_ of _TOTAL_ entries'),
    paginate: {
      previous: '‹',
      next: '›'
    }
  ...
  columns: [{
    ...
    data: 'agv.Name',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('AGV')
  }, // { data: 'lines.Symbols'        , defaultContent: '' ,title: t('Line')},
  {
    data: 'StatusID',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('Status'),
    render: function render(data) {
      if (data == 5) return (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('Destroy');
      if (data == 2) return (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('Success');
      if (data == 1) return (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('Processing');
      if (data == 0) return (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('Find AGV'); // console.log(1);
    }
  }, {
    data: 'Return_Point',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('Location Take Materials'),
    render: function render(data) {
      return (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('Warehouse');
    }
  }, {
    data: 'lines.Symbols',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('Materials Return Location')
  }, {
    data: 'user_created.username',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('User Created')
  }, {
    data: 'Time_Created',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('Time Start')
  }, {
    data: 'user_updated.username',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('User Updated')
  }, {
    data: 'Time_Updated',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('Time End')
  }, {
    data: {
      ID: 'ID',
      StatusID: 'StatusID'
    },
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('Action'),
    render: function render(data) {
      if (data.StatusID == 0 || data.StatusID == 1) {
        if (role_delete_Trans) {
          return "\n                        <button id=\"del-" + data.ID + "\" class=\"btn btn-success btn-success\" style=\"width: 80px\">\n                        " + (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('Success') + "\n                        </button>\n                        <button id=\"del-" + data.ID + "\" class=\"btn btn-danger btn-delete\" style=\"width: 80px\">\n                        " + (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('Destroy') + "\n                        </button>\n                        ";
        } else {
          return "";
        }
      } else {
        if (data.StatusID == 2) {
          return (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('Success');
        } else {
          return (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('Destroy');
        }
      }
    }
  }]
...
$(document).on('click', '.btn-delete', function () {
  var id = $(this).attr('id'); // let name = $(this).parent().parent().children('td').first().text();

  var Row = $(this).closest("tr");
  var machine = Row.find("td:eq(4)").text();
  $('#modalRequestDes').modal();
  $('#nameDes').text((0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('Command') + ' ' + (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('To') + ' ' + machine);
...
$(document).on('click', '.btn-success', function () {
  ...
  $('#nameSuc').text((0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('Command') + ' ' + (0,_lang__WEBPACK_IMPORTED_MODULE_1__["default"])('To') + ' ' + machine);
