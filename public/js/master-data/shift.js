...
"use strict";
/*!*******************************************!*\
  !*** ./resources/js/master-data/shift.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
...
var route = "".concat(window.location.origin, "/api/settings/shift");
var route_show = "".concat(window.location.origin, "/setting/setting-shift/show");
var route_his = "".concat(window.location.origin, "/api/settings/shift/history");
var route_return = "".concat(window.location.origin, "/setting/setting-shift/return");
console.log(route);
var table = $('.table-shift').DataTable({
  ...
  columns: [// { data: 'ID', defaultContent: '', title: 'ID' },
  {
    data: 'Name',
    defaultContent: '',
  ...
  }, // { data: 'Symbols', defaultContent: '', title: t('Symbols') },
  {
    data: 'Start_Time',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])('Start Time')
  }, {
    data: 'End_Time',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])('End Time')
  }, {
    data: 'Note',
    defaultContent: '',
