...
"use strict";
/*!******************************************!*\
  !*** ./resources/js/master-data/mold.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
...
var route = "".concat(window.location.origin, "/api/settings/mold");
var route_show = "".concat(window.location.origin, "/setting/setting-mold/show");
var route_his = "".concat(window.location.origin, "/api/settings/mold/history");
var route_return = "".concat(window.location.origin, "/setting/setting-mold/return");
var table = $('.table-mold').DataTable((_$$DataTable = {
  scrollX: true,
  searching: false,
  ordering: false,
  language: {
  ...
  data: function data(d) {
    delete d.columns;
    delete d.order;
    delete d.search; // const formData = new FormData($('#overall-form')[0])
  ...
  data: 'CAV_Max',
  defaultContent: '',
  title: (0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])('Cavity')
}, {
  data: 'Note',
  defaultContent: '',
...
var tablehis = $('.table-his').DataTable((_$$DataTable2 = {
  ...
  processing: true,
  serverSide: true
}, _defineProperty(_$$DataTable2, "searching", false), _defineProperty(_$$DataTable2, "lengthMenu", [10, 20, 30, 40, 50]), _defineProperty(_$$DataTable2, "ajax", {
  url: route_his,
  dataSrc: 'data',
  data: function data(d) {
    delete d.columns;
