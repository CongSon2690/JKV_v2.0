...
"use strict";
/*!*******************************************!*\
  !*** ./resources/js/master-data/error.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
...
var route = "".concat(window.location.origin, "/api/settings/error");
var route_show = "".concat(window.location.origin, "/setting/setting-error/show");
var route_return = "".concat(window.location.origin, "/setting/setting-error/return");
var table = $('.table-error').DataTable((_$$DataTable = {
  scrollX: true,
  searching: false,
  ordering: false,
  language: {
