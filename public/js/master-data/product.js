...
"use strict";
/*!*********************************************!*\
  !*** ./resources/js/master-data/product.js ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lang__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../lang */ "./resources/js/lang/index.js");
$('.select2').select2();

var route = "".concat(window.location.origin, "/api/settings/product");
var route_show = "".concat(window.location.origin, "/setting/setting-product/show");
var route_bom = "".concat(window.location.origin, "/setting/setting-product/bom");
var route_his = "".concat(window.location.origin, "/api/settings/product/history");
var route_return = "".concat(window.location.origin, "/setting/setting-product/return");
console.log(route);
...
var table = $('.table-product').DataTable({
  ...
  columns: [{
    ...
    data: 'Symbols',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])('Symbols') + ' ' + (0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])('Product')
  }, {
    data: {
      id: 'ID',
      status: 'Status'
    ...
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])('Semi-Product'),
    ...
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])('Materials'),
    render: function render(data) {
      var a = '';
      $.each(data.bom, function (index, value) {
...
$(document).on('click', '.btn-delete', function () {
  ...
  $('#nameDel').text((0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])('Product') + ' : ' + col1);
