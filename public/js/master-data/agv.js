...
"use strict";
/*!*****************************************!*\
  !*** ./resources/js/master-data/agv.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
...
var route = "".concat(window.location.origin, "/api/settings/agv");
var route_show = "".concat(window.location.origin, "/setting/setting-agv/show");
var route_his = "".concat(window.location.origin, "/api/settings/agv/history"); // console.log(route);

var table = $('.table-agv').DataTable({
  scrollX: true,
  aaSorting: [],
  language: {
  ...
  columns: [{
    ...
    data: 'MAC',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])('MAC')
  }, {
    data: 'Type',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])('Type'),
    render: function render(data) {
      if (data == 1) return (0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])('NAV');
      if (data == 2) return (0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])('SHIV TYPE');
      if (data == 3) return (0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])('AMR');
    }
  }, {
    data: 'Active',
    defaultContent: '',
    ...
    render: function render(data) {
      if (data == 2) return (0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])('Enable');
      if (data == 1) return (0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])('Disable');
    }
  }, {
    data: 'Note',
    defaultContent: '',
...
$('table').on('page.dt', function () {// console.log(table.page.info())
});
...
var tablehis = $('.table-his').DataTable((_$$DataTable = {
  ...
  render: function render(data) {
    ...
    if (datas.Active == 2) {
      return (0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])("ENABLE");
    }

    if (datas.Active == 1) {
      return (0,_lang__WEBPACK_IMPORTED_MODULE_0__["default"])("DISABLE");
    }
  }
}, {
  data: 'Action_Name',
  ...
  render: function render(data) {
    var datas = JSON.parse(data);
    var timecreated = moment__WEBPACK_IMPORTED_MODULE_1___default()(datas.Time_Updated, 'MMMM Do YYYY h:mm:ss a').format('YYYY-MM-DD HH:mm:ss');
    return timecreated;
  }
}]), _$$DataTable));
