...
"use strict";
/*!***********************************************!*\
  !*** ./resources/js/master-data/materials.js ***!
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lang__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../lang */ "./resources/js/lang/index.js");
$('.select2').select2();

var route = "".concat(window.location.origin, "/api/settings/materials");
var route_show = "".concat(window.location.origin, "/setting/setting-materials/show");
var route_his = "".concat(window.location.origin, "/api/settings/materials/history");
var route_return = "".concat(window.location.origin, "/setting/setting-materials/return");
console.log(route);
