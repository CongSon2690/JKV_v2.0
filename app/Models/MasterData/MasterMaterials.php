...
class MasterMaterials extends Model
{
  ...
  protected $fillable   = [
    'Name', 'Symbols', 'Unit_ID', 'Packing_ID', 'Supplier_ID', 'Model', 'Standard_Unit', 'Standard_Packing', 'Part_ID', 'Difference', 'Wire_Type', 'Spec', 'Note', 'Norms', 'Time_Created', 'User_Created', 'Time_Updated', 'User_Updated', 'IsDelete'
  ];
