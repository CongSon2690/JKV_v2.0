            ...
            filter_detail(dataDetail).done(function(data)
            {
                ...
                for (let dat of data.data)
                {
                    ...
                    for(let label of dat.inventory_nl)
                    {
                        ...
                        a = a+`
                        <tr class="cill">
                            <td>`+(label.materials ? label.materials.Symbols : label.product.Symbols)+`</td>
                            <td>`+(label.supplier ? label.supplier.Symbols : '' )+`</td>
                            <td>`+parseFloat(label.Inventory)+`</td>
                            <td>`+(label.materials ? (label.materials.unit ? label.materials.unit.Symbols : 'kg') : 'pcs')+`</td>
            ...
            filter_detail_history(dataDetail).done(function(data)
            {
                ...
                for (let dat of data.data)
                {
                    ...
                    b = b+`
                        <tr class="cill1">
                            <td>`+(i++)+`</td>
                            <td>`+ (dat.materials ? dat.materials.Symbols : dat.product.Symbols) +`</td>
                            <td>`+(dat.supplier ? dat.supplier.Symbols : '' )+`</td>
                            <td>`+parseFloat(dat.Quantity)+`</td>
                            <td>`+(dat.materials ? (dat.materials.unit ? dat.materials.unit.Symbols : 'kg') : 'pcs')+`</td>
                            <td>`+dat.Pallet_ID+`</td>
                            <td>`+dat.Count+`</td>
                            <td>`+dat.Box_ID+`</td>
                            <td>`+c+`</td>
